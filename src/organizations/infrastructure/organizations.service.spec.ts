...
describe('OrganizationsService', () => {
  ...
  describe('findOne', () => {
    it('should return an organization by id', async () => {
      ...
      const found = await organizationsService.findOne(saved.id);
  ...
  describe('inviteUser', () => {
    ...
    it('should invite existing user to organization', async () => {
      ...
      const updatedOrg = await organizationsService.findOne(organization.id);
    ...
    it('should throw BadRequestException when user is already a member', async () => {
      ...
      jest.spyOn(usersService, 'find').mockResolvedValueOnce([existingMember]);
  ...
  describe('findAllWhereMember', () => {
    it('should return all organizations where user is a member', async () => {
      ...
      expect(userOrganizations.some((o) => o.name === 'Member Org')).toBe(true);
      expect(userOrganizations.every((o) => o.name !== 'Non-Member Org')).toBe(
        true,
      );
    });
