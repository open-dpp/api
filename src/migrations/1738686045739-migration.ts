...
export class Migration1738686045739 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "data_field" ("id" uuid NOT NULL, "name" character varying NOT NULL, "type" "public"."data_field_type_enum" NOT NULL, "value" jsonb NOT NULL, "sectionId" uuid, CONSTRAINT "PK_3a8385bfd834043ee3e0eadc5b7" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "product_data_model" ("id" uuid NOT NULL, CONSTRAINT "PK_894e5d05d765d5ac4d53e7f90d1" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
